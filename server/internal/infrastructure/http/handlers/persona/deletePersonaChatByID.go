...
func (h *httpHandler) deletePersonaChatByID(w http.ResponseWriter, r *http.Request) {
	...
	err = h.personaService.DeletePersonaChatByID(userID, uint(personaID), uint(chatID))
	if err != nil {
