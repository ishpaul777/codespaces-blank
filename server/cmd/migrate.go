...
func buildSchema() error {
	...
	err = db.AutoMigrate(&models.Chat{}, &models.Document{}, &models.Prompt{}, &models.User{}, &models.Image{}, &models.ChatCollection{}, &models.PromptTemplate{}, &models.PromptTemplateCollection{})
	if err != nil {
		return err
	}
	return nil
