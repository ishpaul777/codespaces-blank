  ...
  const menuOptions = [
    {
      ...
      description: "Discover the wonders of AI chatbots with our versatile multipurpose companion. Engage in captivating conversations that offer assistance, insights, and entertainment, opening up a world of immersive experiences.",
    ...
    },
    {
      ...
      link: defaultPersonas.length > 0 ? `/personas/${defaultPersonas?.find((persona) => persona.slug === 'factcheck-writer')?.id}/chat` : '/',
    },
    {
      title: "Connect with a Social Media Content Creator Expert",
      description: "Unleash your social media content potential with our expert bot! Connect and chat with our Social Media Content Creator Expert Bot for valuable insights and guidance. Elevate your content game and achieve social media success like never before.",
      icon: <SlSocialInstagram className="text-5xl" color={iconColor} />,
      link: defaultPersonas.length > 0 ? `/personas/${defaultPersonas?.find((persona) => persona.slug === 'social-media-content-creator')?.id}/chat` : '/',
    }, 
    {
      title: "Connect with the expert script writer",
      description: "Unlock the truth with our expert Script Writer Bot. Crafted for accuracy and engagement, it delves into various topics, exposing misinformation. Educate, inform, and empower your audience with compelling scripts tailored to their chosen topic and desired tone.",
      icon: <TfiWrite className="text-5xl" color={iconColor} />,
      link: defaultPersonas.length > 0 ? `/personas/${defaultPersonas?.find((persona) => persona.slug === 'script-writer')?.id}/chat` : '/',
    }, 
    {
      title: "Create Your Own Custom Persona and Chat Away!",
      description: "Unleash your creativity and build a personalized chat persona that reflects your unique style. Dive into the world of customized conversations by creating your own persona and engage in captivating chats tailored to your preferences. Click the card to embark on a journey of self-expression and enjoy meaningful interactions with your very own custom chat persona.",
