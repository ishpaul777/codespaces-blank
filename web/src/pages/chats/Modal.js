...
function Modal(props) {
  ...
  } top-1/2 transform -translate-x-1/2 flex flex-col justify-between -translate-y-1/2 bg-white rounded-md shadow-lg p-4 minh-2/5 transition-all duration-300 ease-in-out`;
